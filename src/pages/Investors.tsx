		...
		<div className="min-h-screen bg-gray-50">
			...
			<div className="bg-white border-b border-gray-200">
				<div className="max-w-7xl mx-auto px-4 py-8">
					<h1 className="text-4xl font-bold text-gray-900 mb-2">Investor Relations</h1>
					<p className="text-lg text-gray-600">Discover growth opportunities with India's leading diagnostic healthcare company.</p>
				</div>
			</div>
