...
const StatsSection = () => {
	const stats = [
		...
		},
		{
			...
			icon: <FaMapMarkerAlt className="text-4xl text-blue-600 mb-4" />,
			...
			<div className="max-w-7xl mx-auto px-4 relative z-10">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
					{stats.map((stat) => (
						<div
							key={stat.id}
							className="bg-white shadow-xl border border-gray-200 rounded-2xl p-8 text-center hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-blue-50">
				...
				<div className="bg-white shadow-lg border border-gray-200 rounded-2xl p-8 mb-12">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
						{trustBadges.map((badge, index) => (
							<div
								key={index}
								className="bg-white rounded-xl p-6 text-center hover:shadow-xl transition-all duration-300 hover:scale-105">
				...
				<div className="text-center">
					<div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 md:p-12 shadow-xl">
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							<button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg">
								Book Test Now
							</button>
							<button className="bg-white border-2 border-white text-blue-600 hover:bg-gray-50 font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:scale-105">
								Find Nearest Lab
							</button>
						</div>
